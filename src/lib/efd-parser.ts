...
const RECORD_DEFINITIONS: { [key: string]: string[] } = {
  ...
  'I990': ['REG', 'QTD_LIN_I'],
  'M001': ['REG', 'IND_MOV'],
  'M100': ['REG', 'COD_CRED', 'IND_CRED_ORI', 'VL_BC_PIS', 'ALIQ_PIS', 'QUANT_BC_PIS', 'ALIQ_PIS_QUANT', 'VL_CRED_APU', 'VL_AJUS_ACRES', 'VL_AJUS_REDUC', 'VL_CRED_DIFER', 'VL_CRED_COMP', 'VL_CRED_PER', 'VL_SALDO_CRED', 'VL_CRED_EXT_REC', 'COD_CTA'],
  'M105': ['REG', 'NAT_BC_CRED', 'CST_PIS', 'VL_BC_PIS_TOT', 'VL_BC_PIS_CUM', 'VL_BC_PIS_NC', 'QUANT_BC_PIS_TOT', 'QUANT_BC_PIS_CUM', 'QUANT_BC_PIS_NC', 'DESC_CRED'],
  ...
  'M210': ['REG', 'COD_CONT', 'VL_REC_BRT', 'VL_BC_CONT', 'VL_AJUS_ACRES_BC_PIS', 'VL_AJUS_REDUC_BC_PIS', 'QUANT_BC_PIS', 'ALIQ_PIS_QUANT', 'VL_CONT_APUR', 'VL_AJUS_ACRES', 'VL_AJUS_REDUC', 'VL_CONT_DIFER', 'VL_CONT_DIFER_ANT', 'VL_CONT_RET', 'VL_CRED_PER_APU_ANT', 'VL_COMP_PIS', 'VL_PIS_PAG_RET', 'VL_PIS_PAG_OUT', 'VL_PIS_DISP', 'COD_CTA'],
  ...
  'M505': ['REG', 'NAT_BC_CRED', 'CST_COFINS', 'VL_BC_COFINS_TOT', 'VL_BC_COFINS_CUM', 'VL_BC_COFINS_NC', 'QUANT_BC_COFINS_TOT', 'QUANT_BC_COFINS_CUM', 'QUANT_BC_COFINS_NC', 'DESC_CRED'],
  ...
  'M610': ['REG', 'COD_CONT', 'VL_REC_BRT', 'VL_BC_CONT', 'VL_AJUS_ACRES_BC_COFINS', 'VL_AJUS_REDUC_BC_COFINS', 'QUANT_BC_COFINS', 'ALIQ_COFINS_QUANT', 'VL_CONT_APUR', 'VL_AJUS_ACRES', 'VL_AJUS_REDUC', 'VL_CONT_DIFER', 'VL_CONT_DIFER_ANT', 'VL_CONT_RET', 'VL_CRED_PER_APU_ANT', 'VL_COMP_COFINS', 'VL_COFINS_PAG_RET', 'VL_COFINS_PAG_OUT', 'VL_COFINS_DISP', 'COD_CTA'],
  'M611': ['REG', 'IND_TIP_COOP', 'VL_BC_CONT_ANT_EXC_COOP', 'VL_EXC_COOP_GER', 'VL_EXC_ESP_COOP', 'VL_BC_CONT_COOP'],
