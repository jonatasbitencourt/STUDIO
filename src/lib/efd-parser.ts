...
const RECORD_DEFINITIONS: { [key: string]: string[] } = {
  ...
  'C191': ['REG', 'CNPJ_CPF_PART', 'CST_PIS', 'CFOP', 'VL_ITEM', 'VL_BC_PIS', 'ALIQ_PIS', 'QUANT_BC_PIS', 'ALIQ_PIS_QUANT', 'VL_PIS', 'COD_CTA'],
  'C195': ['REG', 'CNPJ_CPF_PART', 'CST_COFINS', 'CFOP', 'VL_ITEM', 'VL_BC_COFINS', 'ALIQ_COFINS', 'QUANT_BC_COFINS', 'ALIQ_COFINS_QUANT', 'VL_COFINS', 'COD_CTA'],
  'C198': ['REG', 'NUM_PROC', 'IND_PROC'],
  'C199': ['REG', 'NUM_DOC_IMP', 'VL_PIS_IMP', 'VL_COFINS_IMP'],
  ...
  'M210': ['REG', 'COD_CONT', 'VL_REC_BRU', 'VL_BC_CONT', 'VL_AJUS_ACRES_BC', 'VL_AJUS_REDUC_BC', 'VL_CONT_APUR', 'VL_CRED_DESC', 'VL_CONT_DEVIDO', 'VL_DED_ANT', 'VL_DED_PER', 'VL_DED_EXT', 'VL_CONT_EXT', 'VL_CONT_DEV', 'VL_RET', 'VL_OUT_DED', 'VL_CONT_REC', 'VL_CONT_PAG', 'VL_CONT_DCOMP', 'VL_CRED_TRANS'],
  ...
  'M610': ['REG', 'COD_CONT', 'VL_REC_BRU', 'VL_BC_CONT', 'VL_AJUS_ACRES_BC', 'VL_AJUS_REDUC_BC', 'VL_CONT_APUR', 'VL_CRED_DESC', 'VL_CONT_DEVIDO', 'VL_DED_ANT', 'VL_DED_PER', 'VL_DED_EXT', 'VL_CONT_EXT', 'VL_CONT_DEV', 'VL_RET', 'VL_OUT_DED', 'VL_CONT_REC', 'VL_CONT_PAG', 'VL_CONT_DCOMP', 'VL_CRED_TRANS'],
